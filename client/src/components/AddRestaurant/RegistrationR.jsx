                ...
                return (
                    <div className="form-section">
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="form-group">
                                <label>Don't have a FSSAI license? <a href="https://foodlicenseportal.org/Home/application?gad_source=1&gclid=CjwKCAiAg8S7BhATEiwAO2-R6iS04jlDci6y2FfBPdkMXh9qmUNYomnlGO436p5IQjGIhBu-SqRpfRoCnVAQAvD_BwE">Apply here</a></label>
                            </div>
                            <div className="form-group">
